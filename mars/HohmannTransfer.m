function [ time, gamma, v,r,theta,acc, data ] = HohmannTransfer( rad1, rad2,beta,timeSteps,dragOn,theta0, gamma0  )
...
dv1 = abs(sqrt(muMars/rad1)*(sqrt(2*rad2/(rad1+rad2))-1)); %delta v for first maneuver
...
%% Second Maneuver
dv2 = abs(sqrt(muMars/rad2)*(1-sqrt(2*rad1/(rad1+rad2))));
dvTotal = dv1+dv2;
gamma0 = gamma1(end);
gamma0 = 0;
v0 = v1(end)-dv2;
